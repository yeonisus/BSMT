...
BSMT 0.26.2 is packaged for Windows x64 and audited for platform assumptions
...
- [ ] `bsmt-0.26.2.zip` downloaded **without the browser unzipping it**
...
- [ ] Uninstall the extension, install `body_surface_measurement-0.26.2.zip`
      (no solver) instead
- [ ] BSMT still enables
