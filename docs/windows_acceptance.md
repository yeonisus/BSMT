...
BSMT 0.20.0 is packaged for Windows x64 and audited for platform assumptions
...
- [ ] `bsmt-0.20.0.zip` downloaded **without the browser unzipping it**
...
- [ ] Uninstall the extension, install `body_surface_measurement-0.20.0.zip`
      (no solver) instead
- [ ] BSMT still enables
